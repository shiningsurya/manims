...
CONFIG={
        "name":"Binomial tree", 
        "cat":"Reduce", 
        "desc":"All nodes have the data and reduced data is brought to one node.",
        "ndbs":16,
        "ndbs_x":4, 
        "ndbs_y":4,
        "ncpus":8,
...
class Reduce_Binomial(Scene):
    ...
    def construct (self):
        ...
        ss = deepcopy (INIT_CONF)
        sss = [STATE[0],STATE[0],STATE[0],STATE[0]]
        ###
        self.construct_step (
            [1, 5, 3, 7],
            [0, 4, 2, 6],
